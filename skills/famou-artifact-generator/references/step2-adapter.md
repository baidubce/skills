...
Step 2 is the **single source of truth** for implementation requirements.
...
Implement this fixed interface:
...
- `combined_score` must be numeric and higher-is-better: `0` means the solution is invalid, a low score means the solution is valid but performs poorly, and a high score means the solution is valid and the algorithm quality is high.
